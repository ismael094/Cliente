...
@NamedQueries({
    ...
    , @NamedQuery(name = "Compras.find", query = "SELECT c FROM Compras c WHERE c.id like \"%_%\"")
...
public class ComprasModel implements Serializable {
    ...
    public ComprasModel(Integer id) {
        this.id = id;
    }

    public ComprasModel(Integer id, int cantidad) {
        this.id = id;
    ...
    public boolean equals(Object object) {
        ...
        if (!(object instanceof ComprasModel)) {
            return false;
        }
        ComprasModel other = (ComprasModel) object;
